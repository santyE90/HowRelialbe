"""CLI for Phase 2E NHTSA manufacturer communications."""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Process official NHTSA manufacturer communications"
    )
    ...
    ingest.add_argument("--communications", type=Path, required=True)
    ...
    match.add_argument("--communications", type=Path, required=True)
    ...
    match.add_argument("--cohort-evidence", type=Path, required=True)
